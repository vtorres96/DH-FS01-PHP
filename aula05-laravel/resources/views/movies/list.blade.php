            ...
            <article class="col-12">
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td scope="row">
                                <img width="80" height="80" src="{{ $movie->cover_image == null ? asset('img/sem-imagem.jpg') : asset($movie->cover_image) }}" alt="">
                            </td>
                            <td scope="row">{{$movie->title}}</td>
                            <td scope="row">{{$movie->synopsis}}</td>
                            <td scope="row">{{$movie->genre->description}}</td>
                            <td>
                ...
                <div class="d-flex justify-content-center">
                    {{-- paginando registros sem filtro de busca --}}
                    {{-- {{ $movies->links() }} --}}
                    {{-- paginando registros com filtro de busca --}}
